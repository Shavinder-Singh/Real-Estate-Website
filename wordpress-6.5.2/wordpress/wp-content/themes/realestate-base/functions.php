...
if ( ! function_exists( 'realestate_base_blocks_support' ) ) :
	/**
	 * Create add default blocks support
	 */
	function realestate_base_blocks_support() {
		...
		add_theme_support(
			...
			array(
				array(
					'name'      => esc_html__( 'Small', 'realestate-base' ),
					'shortName' => esc_html__( 'S', 'realestate-base' ),
					'size'      => 14,
					'slug'      => 'small',
				),
				array(
					'name'      => esc_html__( 'Normal', 'realestate-base' ),
					'shortName' => esc_html__( 'M', 'realestate-base' ),
					'size'      => 18,
					'slug'      => 'normal',
				),
				array(
					'name'      => esc_html__( 'Large', 'realestate-base' ),
					'shortName' => esc_html__( 'L', 'realestate-base' ),
					'size'      => 42,
					'slug'      => 'large',
				),
				array(
					'name'      => esc_html__( 'Huge', 'realestate-base' ),
					'shortName' => esc_html__( 'XL', 'realestate-base' ),
					'size'      => 54,
					'slug'      => 'huge',
				),
			)
		...
		add_theme_support( 'editor-color-palette', array(
			array(
				'name'  => esc_html__( 'White', 'realestate-base' ),
				'slug'  => 'white',
				'color' => '#ffffff',
			),
			array(
				'name'  => esc_html__( 'Black', 'realestate-base' ),
				'slug'  => 'black',
				'color' => '#111111',
			),
			array(
				'name'  => esc_html__( 'Gray', 'realestate-base' ),
				'slug'  => 'gray',
				'color' => '#f4f4f4',
			),
			array(
				'name'  => esc_html__( 'Blue', 'realestate-base' ),
				'slug'  => 'blue',
				'color' => '#1b8be0',
			),
			array(
				'name'  => esc_html__( 'Yellow', 'realestate-base' ),
				'slug'  => 'yellow',
				'color' => '#bf9410',
			),
			array(
				'name'  => esc_html__( 'Fade Blue', 'realestate-base' ),
				'slug'  => 'fade-blue',
				'color' => '#32506d',
			),
		) );
	}
	add_action( 'after_setup_theme', 'realestate_base_blocks_support', 20 );
endif; //realestate_base_blocks_support

if ( ! function_exists( 'realestate_base_add_blocks_style' ) ) :
	/**
	 * Add Blocks Style
	 */
	function realestate_base_add_blocks_style() {
		// Theme block stylesheet.
		wp_enqueue_style( 'realestate-base-block-style', get_theme_file_uri( '/css/blocks.css' ), array( 'realestate-base-style' ), date( 'Ymd-Gis', filemtime( get_template_directory() . '/css/blocks.css' ) ) );
	}
	add_action( 'wp_enqueue_scripts', 'realestate_base_add_blocks_style' );
endif; //realestate_base_add_blocks_style

if ( ! function_exists( 'realestate_base_block_editor_styles' ) ) :
	/**
	 * Enqueue editor styles for Blocks
	 */
	function realestate_base_block_editor_styles() {
		// Block styles.
		wp_enqueue_style( 'realestate-base-block-editor-style', get_theme_file_uri( '/css/editor-blocks.css' ), null, date( 'Ymd-Gis', filemtime( get_template_directory() . '/css/editor-blocks.css' ) ) );

		// Add custom fonts.
		wp_enqueue_style( 'realestate-base-fonts', realestate_base_fonts_url(), array(), null );
	}
	add_action( 'enqueue_block_editor_assets', 'realestate_base_block_editor_styles' );
endif; //realestate_base_block_editor_styles
